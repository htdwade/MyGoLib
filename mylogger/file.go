...
func (f *FileLogger) initFile() error {
	...
	fileObj, err := os.OpenFile(fullFileName, os.O_RDWR|os.O_CREATE|os.O_APPEND, 0666)
	if err != nil {
		fmt.Printf("open log file failed, err:%v\n", err)
		return err
	}
	errFileObj, err := os.OpenFile(fullFileName+".err", os.O_RDWR|os.O_CREATE|os.O_APPEND, 0666)
	if err != nil {
...
func (f *FileLogger) splitFile(file *os.File) (*os.File, error) {
	...
	// 3. 打开一个新的日志文件
	fileObj, err := os.OpenFile(logName, os.O_RDWR|os.O_CREATE|os.O_APPEND, 0666)
	if err != nil {
